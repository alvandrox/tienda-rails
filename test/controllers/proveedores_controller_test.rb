...
class ProveedoresControllerTest < ActionController::TestCase
  ...
  test "should create proveedor" do
    assert_difference('Proveedor.count') do
      post :create, proveedor: { direccion: @proveedor.direccion, email: @proveedor.email, nombre: @proveedor.nombre, razon_social: @proveedor.razon_social, rut: @proveedor.rut, telefono: @proveedor.telefono, url: @proveedor.url }
    end
  ...
  test "should update proveedor" do
    patch :update, id: @proveedor, proveedor: { direccion: @proveedor.direccion, email: @proveedor.email, nombre: @proveedor.nombre, razon_social: @proveedor.razon_social, rut: @proveedor.rut, telefono: @proveedor.telefono, url: @proveedor.url }
    assert_redirected_to proveedor_path(assigns(:proveedor))
  end

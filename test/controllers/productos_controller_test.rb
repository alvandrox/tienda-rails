...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { categoria_id: @producto.categoria_id, codigo: @producto.codigo, descripcion: @producto.descripcion, marca_id: @producto.marca_id }
    end
  ...
  test "should update producto" do
    patch :update, id: @producto, producto: { categoria_id: @producto.categoria_id, codigo: @producto.codigo, descripcion: @producto.descripcion, marca_id: @producto.marca_id }
    assert_redirected_to producto_path(assigns(:producto))
  end

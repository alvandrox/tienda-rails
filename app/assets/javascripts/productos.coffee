...
$('#form-articulo').keyup ->
  ...
  switch
    ...
    when porcentaje_ganancia > 30 then $('#calculos-articulos').removeClass('alert alert-warning') $('#calculos-articulos').addClass('alert alert-success')

#  if porcentaje_ganancia < 30
#    $('#calculos-articulos').addClass('alert alert-danger')
#  else if porcentaje_ganancia 30..35
